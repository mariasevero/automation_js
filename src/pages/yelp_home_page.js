class YelpHomePage {
  ...
  /**
   * The selectCategoryFromList method selects an element from the findCategoryList.
   * The selected element is passed as an argument whose origin is in the scenario
   * definition of the yelp_search feature.
   */
  selectCategoryFromList(findCategoryValue) {
    this.findCategoryList.waitForVisible(5000);
    const selector = `[data-suggest-query='${findCategoryValue}'] .suggestion-title`;
